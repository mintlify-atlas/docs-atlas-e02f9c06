...
description: "StockManager uses Flask session cookies for authentication. Log in via POST /api/login, get a session cookie, and send it with every subsequent request."
---
