---
title: "Audit API — Query the Full Change History"
sidebarTitle: "Audit"
description: "Query StockManager's audit trail by user, entity type, action, or date range. Track every create, update, delete, login, and approval event across the system."
---
