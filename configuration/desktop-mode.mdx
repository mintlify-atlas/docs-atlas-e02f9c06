---
title: "Running StockManager as a Native Desktop Application"
sidebarTitle: "Desktop Mode"
description: "StockManager wraps its Flask server in a PyWebView window. Run in dev mode, build a standalone executable with PyInstaller, or configure window settings."
---
