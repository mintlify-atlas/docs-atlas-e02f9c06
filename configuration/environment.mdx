---
title: "Environment Variables and Server Configuration Guide"
sidebarTitle: "Environment"
description: "Configure StockManager's Flask secret key, SMTP credentials, log level, and database path using environment variables or a .env file."
---
