---
title: "SQLite Database Architecture and Schema Reference Guide"
sidebarTitle: "Database"
description: "StockManager uses SQLite with WAL mode and thread-local connections. Covers PRAGMA settings, all table schemas, indexes, and scheduled maintenance."
---
