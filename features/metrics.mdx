---
title: "Business Analytics Dashboard and KPIs"
...
| `low_stock_list` | array | Top 10 products closest to running out (sorted by quantity ascending) |
| `expire_soon` | integer | Active products expiring within the next 7 days |
